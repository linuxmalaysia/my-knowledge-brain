...
sidebarTitle: "Ingestion Latency And"
...
|---|---|
| [BYTE-CAPPED-EXECUTION-FRAMEWORK.md](BYTE-CAPPED-EXECUTION-FRAMEWORK) | Enforcement model for Byte-Capped Executions (Rule 10). |
| [DSOM-TOKEN-EFFICIENCY-REPORT.md](DSOM-TOKEN-EFFICIENCY-REPORT) | Token efficiency audit proving 96.23% reduction via DSOM protocol. |
