...
sidebarTitle: "Reasoning Gap What"
description: "OKF-compliant documentation for RESEARCH-REASONING-GAP.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
| Document | Relevance |
|---|---|
| [`docs/PALACE-BUILD-STORY.md`](../PALACE-BUILD-STORY) | Why the Palace was built |
...
| [`docs/EOD-RITUAL.md`](../EOD-RITUAL) | Hibernation Notes export protocol |
