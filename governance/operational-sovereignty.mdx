...
sidebarTitle: "Operational Sovereignty Through"
description: "OKF-compliant documentation for OPERATIONAL-SOVEREIGNTY.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
> **Full strategic doctrine:** [`docs/GITOPS-AIOPS-ANSIBLE-STRATEGY.md`](GITOPS-AIOPS-ANSIBLE-STRATEGY)
...
> **Setup guide:** [`docs/HOWTO-SETUP-WSL-ALMALINUX10.md`](../HOWTO-SETUP-WSL-ALMALINUX10)
> **Ansible baseline:** [`docs/HOWTO-SETUP-ANSIBLE-BASELINE.md`](../HOWTO-SETUP-ANSIBLE-BASELINE.md)
> **Environment map:** [`docs/AI-COGNITIVE-TWIN-PROTOCOL.md`](AI-COGNITIVE-TWIN-PROTOCOL), fill once per project
...
> **EOD procedure:** [`docs/EOD-RITUAL.md`](../EOD-RITUAL), Step 2a (Ansible Palace EOD)
> **SOD procedure:** [`docs/SOD-RITUAL.md`](../SOD-RITUAL), Step 1a (Ansible Palace SOD)
> **AI prompts:** [`docs/REANIMATION-PROMPT-TEMPLATE.md`](../REANIMATION-PROMPT-TEMPLATE), 5 copy-paste prompts
