...
sidebarTitle: "Vs Llm Wiki"
description: "Analysis of Andrej Karpathy's LLM WIKI concept and how it maps to DSOM architecture. Deep State of Mind framework. Deep State of Mind framework."
---

> **Entry Point 8:** This document serves as the Sovereign Knowledge Entry Point. See [START-HERE.md](../../START-HERE) for the master onboarding roadmap.
