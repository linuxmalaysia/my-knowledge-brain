...
sidebarTitle: "Master Directive Ai"
description: "OKF-compliant documentation for AI-MASTER-PROTOCOL.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
Git is the **single source of truth** for all system state. If a change is not committed to the repository, it does not exist. No manual edits to target nodes are permitted. See [`docs/GITOPS-AIOPS-ANSIBLE-STRATEGY.md`](GITOPS-AIOPS-ANSIBLE-STRATEGY) for the full doctrine.
...
2. **Twin Protocol Check:** Verify `docs/AI-COGNITIVE-TWIN-PROTOCOL.md` exists for this project. If it does not, flag it as the first action item. See [`docs/AI-COGNITIVE-TWIN-PROTOCOL.md`](AI-COGNITIVE-TWIN-PROTOCOL).
