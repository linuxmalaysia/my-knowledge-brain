...
sidebarTitle: "Operational Level 3"
description: "OKF-compliant documentation for OPERATIONAL-GUIDE.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
- **Guide:** [HOWTO: Adopt DSOM in Existing Projects](../HOWTO-ADOPT-DSOM)

### Scenario 2: Legacy Upgrade

- **Situation:** You have an older DSOM version (v3/v4) and want to upgrade to v5.x (ITIL/Privacy).
- **Guide:** [HOWTO: Upgrade and Audit DSOM](../HOWTO-UPGRADE-DSOM)
...
- **Guide:** [HOWTO: Palace Onboarding](../HOWTO-PALACE-ONBOARDING)
...
For full doctrine, see [`docs/GITOPS-AIOPS-ANSIBLE-STRATEGY.md`](GITOPS-AIOPS-ANSIBLE-STRATEGY).
