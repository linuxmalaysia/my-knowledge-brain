...
sidebarTitle: "Token Efficiency Integration"
description: "Comprehensive audit report detailing the 96% token reduction achieved by the DSOM Protocol and recent integration milestones. Deep State of Mind framework."
---
...
def generate_dsom_context() -> str:
    ...
    SOURCES:
    - [START-HERE.md](file:///START-HERE) - Project Entry Points
