...
sidebarTitle: "Agent Plugins 1"
description: "Master governance and architectural integration guide for adopting the open Agent Plugins 1.0.0 specification across DSOM. Deep State of Mind framework."
---
...
- [`docs/governance/DSOM-MCP-ARCHITECTURE.md`](file:///d:/Users/LinuxMalaysia/Projects/deep-state-of-mind-for-my-ai/docs/governance/DSOM-MCP-ARCHITECTURE), FastMCP Server Reference.
