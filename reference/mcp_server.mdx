...
sidebarTitle: "Reference Mcp Server"
description: "FastMCP Model Context Protocol (MCP) server implementation for the DSOM Palace. Deep State of Mind framework. Deep State of Mind framework."
---
