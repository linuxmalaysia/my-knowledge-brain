...
sidebarTitle: "How To Operate"
description: "This guide explains how to initialise, update, and query the local OpenWiki documentation and knowledge graph. Deep State of Mind framework."
---
