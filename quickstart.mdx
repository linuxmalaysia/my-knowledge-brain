---
title: "Get Started with DSOM in Six Steps"
...
Run the brain initialisation script for your platform. This creates the `.agents/brain/` directory and seeds it with the three core temporal artifacts your AI will read at the start of every session.
...
After the script completes, your `.agents/brain/` directory contains three files:
...
The `docs/AI-COGNITIVE-TWIN-PROTOCOL.md` file is the most important file in the entire framework. It is your **Project Identity Card** — the document that tells the AI who you are, what your environment looks like, and how it must behave. Open it and replace every `[PLACEHOLDER]` with your real project details.
...
<Warning>
  The AI will not operate correctly until every `[PLACEHOLDER]` in this file is filled in. The `audit-pre-flight.sh` script in the next step will explicitly flag any unfilled values and block you from proceeding.
</Warning>
