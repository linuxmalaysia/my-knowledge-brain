...
sidebarTitle: "State Sync Skill"
description: "Executes Semantic Compaction locally by analyzing a Git diff and updating current_state.dsom using OpenAI. Deep State of Mind framework."
---
