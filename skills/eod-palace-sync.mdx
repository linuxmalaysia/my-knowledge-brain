...
sidebarTitle: "Eod Palace Sync"
description: "The Hibernation (End of Day) ritual to externalise memory into the Palace and push to Git. Deep State of Mind framework. Deep State of Mind framework."
---
