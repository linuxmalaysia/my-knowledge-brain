...
sidebarTitle: "Latex Proposal Compiler"
description: "Compiles a markdown proposal document into a professionally formatted PDF using Pandoc and XeLaTeX. Contains crucial fixes for TOC generation, double-nu..."
---
