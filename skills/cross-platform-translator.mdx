...
sidebarTitle: "Cross Platform Translator"
description: "Analyses a Windows PowerShell (.ps1) or Linux Bash (.sh) script and automatically generates its functional equivalent in the other shell language, enfor..."
---
