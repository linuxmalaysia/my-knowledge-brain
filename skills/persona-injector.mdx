...
sidebarTitle: "Persona Injector"
description: "Guides a user to define their Sovereign Persona and safely injects it into the agent's core AGENTS.md rulebook. Deep State of Mind framework."
---
