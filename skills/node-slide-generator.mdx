...
sidebarTitle: "Node Slide Generator"
description: "Generates a PowerPoint presentation from a markdown outline using Node.js and pptxgenjs. Deep State of Mind framework. Deep State of Mind framework."
---
