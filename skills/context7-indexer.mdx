...
description: "Governs the use of Context7 for indexing the Sovereign Markdown Palace and retrieving semantic context via MCP. Deep State of Mind framework."
---
