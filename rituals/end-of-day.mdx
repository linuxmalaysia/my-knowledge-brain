...
sidebarTitle: "Eod Ritual Md"
description: "OKF-compliant documentation for EOD-RITUAL.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
| Document | Purpose |
|:---|:---|
| [`docs/SOD-RITUAL.md`](SOD-RITUAL) | Start-of-Day reanimation ritual |
...
| [`docs/HOWTO-PALACE-ONBOARDING.md`](HOWTO-PALACE-ONBOARDING) | Palace structure + closet update guide |
