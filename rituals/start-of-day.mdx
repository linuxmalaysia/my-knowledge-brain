...
sidebarTitle: "Sod Ritual Md"
description: "OKF-compliant documentation for SOD-RITUAL.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
| Document | Purpose |
|:---|:---|
| [`docs/EOD-RITUAL.md`](EOD-RITUAL) | End-of-Day hibernation ritual |
| [`docs/HUMAN-HANDOVER-CONTEXT.md`](HUMAN-HANDOVER-CONTEXT.md) | Session handover prompt template |
| [`docs/REANIMATION-PROMPT-TEMPLATE.md`](REANIMATION-PROMPT-TEMPLATE) | AI session prompts |
| [`docs/AI-COGNITIVE-TWIN-PROTOCOL.md`](governance/AI-COGNITIVE-TWIN-PROTOCOL.md) | Project Identity Card |
| [`docs/AI-MASTER-PROTOCOL.md`](governance/AI-MASTER-PROTOCOL) | The Sovereign Constitution |
| [`docs/RITUAL-OF-TRANSITION.md`](RITUAL-OF-TRANSITION.md) | AI model switch ritual |
| [`docs/HOWTO-PALACE-ONBOARDING.md`](HOWTO-PALACE-ONBOARDING) | Palace structure + AI Walk protocol |
