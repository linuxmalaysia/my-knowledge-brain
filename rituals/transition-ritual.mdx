...
sidebarTitle: "Ritual Of Transition"
description: "OKF-compliant documentation for RITUAL-OF-TRANSITION.md. Deep State of Mind framework. Deep State of Mind framework. Deep State of Mind framework."
---
...
**Full SOD guide:** [`docs/SOD-RITUAL.md`](SOD-RITUAL)
...
**Full EOD guide:** [`docs/EOD-RITUAL.md`](EOD-RITUAL)
...
**Full prompt:** [`docs/REANIMATION-PROMPT-TEMPLATE.md`](REANIMATION-PROMPT-TEMPLATE) → Prompt 3
...
|:---|:---|:---|
| 1 | [`docs/AI-MASTER-PROTOCOL.md`](governance/AI-MASTER-PROTOCOL) | Every session |
| 2 | [`docs/SOD-RITUAL.md`](SOD-RITUAL.md) | Every morning |
| 3 | [`docs/EOD-RITUAL.md`](EOD-RITUAL) | Every evening |
| 4 | [`docs/REANIMATION-PROMPT-TEMPLATE.md`](REANIMATION-PROMPT-TEMPLATE.md) | When prompting AI |
| 5 | [`docs/HUMAN-HANDOVER-CONTEXT.md`](HUMAN-HANDOVER-CONTEXT) | New session, new AI |
